...
参考 [IETE 标准文档](https://tools.ietf.org/html/rfc7231#section-5.5.3) 得出 UA 的构建规则：
...
![](http://km.oa.com/files/photos/pictures/201906/1561358078_79_w3265_h1451.png)
...
1. ^ [User-Agent](https://zh.wikipedia.org/wiki/用户代理). 维基百科.
